...
class FaradayTools():
     """ Class for RM fitting, Faraday de-rotation, etc.
     ...
     def diff(self, params, lam, data):
          ...
          """
          res = self.fr_sin(lam, params) - data

          return abs(res)

     def fit_RM(self, RM_o):
          """ Guesses an initial set of parameters then
          fits to a complex exponential

          Parameters
          ----------
          RM_o : float
               Known rotation measure
